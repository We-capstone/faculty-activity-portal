    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          <button onClick={handleExportPdf} className="flex items-center space-x-2 bg-white border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-all">
            <span>Export PDF</span>
          </button>
          <button onClick={handleExportExcel} className="flex items-center space-x-2 bg-white border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-all">
